...
public class CustomLocationManager {
    ...
    private static com.fyp.womensafetyapp.CustomLocationManager _instance;

    private CustomLocationManager() {}

    public static com.fyp.womensafetyapp.CustomLocationManager getCustomLocationManager() {
        if (_instance == null) {
            _instance = new com.fyp.womensafetyapp.CustomLocationManager();
        }
        return _instance;
    }
    ...
    public boolean getCurrentLocation(Context context, LocationValue result) {
        ...
        mTimer = new Timer();
        mTimer.schedule(new GetLastKnownLocation(), 100);
